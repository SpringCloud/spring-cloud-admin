...
<div>
  <div class="rk-trace-search-box container">
    <div class="item">
      ...
      <select class="app" style=" border: 0; outline: none;" v-model="option.data.applicationId">
  ...
  <div class="container clear">
    <AdminPage class="r" :total="stateTrace.tracesTotal" :currentSize="15" :currentPage="option.page" @changePage="changePage"/>
  </div>
</div>
</template>
