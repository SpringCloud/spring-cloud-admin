...
import RkBoard from '../../components/rocketbot/dashboard/rk-board.vue';
import ChartThroughput from '../../components/rocketbot/dashboard/chart-throughput.vue';
import ChartResponse from '../../components/rocketbot/dashboard/chart-response.vue';
import ChartSla from '../../components/rocketbot/dashboard/chart-sla.vue';
import ChartHeap from '../../components/rocketbot/dashboard/chart-heap.vue';
import ChartNonHeap from '../../components/rocketbot/dashboard/chart-nonheap.vue';
import ChartCpu from '../../components/rocketbot/dashboard/chart-cpu.vue';
import ChartGc from '../../components/rocketbot/dashboard/chart-gc.vue';
import NumBox from '../../components/rocketbot/dashboard/num-box.vue';
import TopThroughput from '../../components/rocketbot/dashboard/top-throughput.vue';
import SlowService from '../../components/rocketbot/dashboard/slow-service.vue';
import TopSlow from '../../components/rocketbot/dashboard/top-slow.vue';
